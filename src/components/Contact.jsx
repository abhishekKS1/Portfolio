...
export default function Contact() {
   ...
   return (
      <>
         <div name="Contact" className="  md:mb-16  max-w-screen-2xl container mx-auto px-8 md:px-20 ">
            ...
            <div className="flex flex-col items-center justify-center mt-16">
               <form
                  ...
                  className="bg-gradient-to-br from-cyan-500 to-blue-500 text-white  md:w-96 px-8 py-6 rounded-xl">
