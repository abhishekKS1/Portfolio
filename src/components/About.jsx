      ...
      <>
         <div name="About" className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-16">
            ...
            impression.
               ...
               <span>
                  Proficient in [Programming Languages] Experienced with [Software Tools/Technologies] Strong grasp of [Design
               ...
               {/* <br /> */}
               <br />
               <h1 className="text-green-600 font-semibold text-xl">Objective</h1>
               <p>
                  My mission is to leverage my skills and creativity to deliver innovative solutions that exceed client expectations and
