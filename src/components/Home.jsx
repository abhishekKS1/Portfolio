        ...
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 mt-12 md:mt24 space-y-2 order-2 md:order-1">
            ...
            <p className="text-sm md:text-md text-justify">
              Welcome to my portfolio! I am a passionate and dedicated
              professional with a keen eye for detail and a commitment to
              excellence. My journey is driven by creativity, innovation, and a
              relentless pursuit of knowledge. Here, you'll find a curated
              collection of my work, showcasing my skills, experiences, and the
              projects I've been privileged to be a part of.
            </p>
            <br />
            {/* social media icons */}
