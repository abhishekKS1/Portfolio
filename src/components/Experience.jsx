...
export default function Experience() {
   const cardItem = [
      { id: 1, logo: git, name: "Git" },
      { id: 2, logo: github, name: "GitHub" },
         ...
         <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 my-3 gap-7">
               {cardItem.map(({ id, logo, name }) => (
                  <div
                     key={id}
                     className="flex flex-col items-center justify-center mt-2 border-[2px] rounded-full md:w-[250px] md:h-[250px] p-3 cursor-pointer hover:scale-105 duration-300">
                     <img src={logo} alt={name} className="w-[120px] h-[120px] rounded-full" />
...
//                      <img src={logo} alt="" className="w-[100px] mt-2  rounded-full " />
//                      <div>
